...
EXPORTS="init_simulation,run_all_steps,run_n_steps,get_nx,get_ny,get_nt,get_nit,get_re,get_dx,get_dy,get_dt,get_rho,get_nu,get_step_count,get_u_at,get_velocity_magnitude_at,get_v_at,get_p_at,get_u_center,get_v_center,get_p_center,get_divergence_norm,get_max_velocity_magnitude,get_max_u,get_max_v,get_max_p,get_min_p,init_simple,run_simple_n_iter,get_simple_step_count,get_simple_residual,get_u_simple_at,get_v_simple_at,get_p_simple_at,get_max_u_simple,get_simple_divergence_norm,init_chorin_pcg,run_chorin_pcg_n_steps,get_pcg_step_count,get_pcg_last_iters,get_u_pcg_at,get_v_pcg_at,get_p_pcg_at,get_velocity_magnitude_pcg_at,get_max_u_pcg,get_max_v_pcg,get_max_p_pcg,get_min_p_pcg,get_pcg_divergence_norm,init_mac,run_mac_n_steps,get_mac_step_count,get_mac_last_iters,get_mac_nc,get_u_mac_at,get_v_mac_at,get_p_mac_at,get_velocity_magnitude_mac_at,get_max_u_mac,get_max_v_mac,get_max_p_mac,get_min_p_mac,get_mac_divergence_norm"
